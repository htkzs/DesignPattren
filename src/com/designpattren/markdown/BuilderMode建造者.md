...
class Director{
    private DefaultCreateProductBuilder builder;

    public Director(DefaultCreateProductBuilder builder) {
...
/*
定义另一个建造者 按照该建造者的建造逻辑进行建造 只需要实现自己的建造者即可。
 */
